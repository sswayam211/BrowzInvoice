...
<head>
    ...
    <title>Browz Invoice || Login</title>
...
<body class="bg-light">
    <div class="login">
            ...
            <div class="login-body p-3">
                ...
                <form action="" method="post" class="mb-0">
                    ...
                    <div class="form-group m-0 d-flex align-content-center justify-content-center">
                        <button type="submit" class="mx-1 login-btn btn">Login</button>
        ...
        <footer>
            <p>Copyright© <?php echo date('Y'); ?>, Icon Technology Projects & Services LLC. All Rights Reserved.</p>
        </footer>
    </div>
