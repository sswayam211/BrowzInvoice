...
<a href="currency-page.php"><button class="back" type="button"><i class="fa-solid fa-arrow-left me-1"></i>Back</button></a>
<div class="add-form py-5">
    <form action="\Office\Browz Invoice\php\handle-add-currency.php" method="post" class="col-md-8 col-sm-10 m-auto shadow p-sm-5 py-5 p-3" style="background-color: white;">
        <div class="form-heading mb-5">
            <h3 class="m-0">Add Currency</h3>
        </div>
        ...
        <div class="alert-box">
            ...
            if (isset($_GET['s']) && $_GET['s'] == '1') {
                ...
                $error = 'Fail to add Currency, please try again';
        ...
        <div class="row">
            ...
            <div class="form-group col-md-4 mb-4">
                <input type="hidden" class="number" name="country-code" id="country-code-1" placeholder="" required>
                <input type="text" class="number" name="country-code" id="country-code-2" placeholder="" disabled required>
                <label for="country-code">Country Code<span class="required">*</span></label>
            </div>
            <div class="form-group col-md-4 mb-4">
                <input type="hidden" name="currency-code" id="currency-code-1" placeholder="" required>
                <input type="text" name="currency-code" id="currency-code-2" placeholder="" disabled required>
                <label for="currency-code">Currency Code<span class="required">*</span></label>
            </div>
            <div class="form-group col-md-4 mb-4">
                <input type="hidden" class="number" name="currency-name" id="currency-name-1" placeholder="" required>
                <input type="text" class="number" name="currency-name" id="currency-name-2" placeholder="" disabled required>
                <label for="currency-name">Currency Name<span class="required">*</span></label>
            </div>
            <div class="form-group col-md-4 mb-4">
                <input type="hidden" class="number" name="currency-symbol" id="currency-symbol-1" placeholder="" required>
                <input type="text" class="number" name="currency-symbol" id="currency-symbol-2" placeholder="" disabled required>
                <label for="currency-symbol">Currency Symbol<span class="required">*</span></label>
            </div>
            <div class="form-group col-md-4 mb-4">
